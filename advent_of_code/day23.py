...
def find_triangular_sets(graph):
...
def find_password(text):
    ...
    network_graph = generate_network_map(connections)
    largest = max(nx.find_cliques(network_graph), key=len)
    largest.sort()
    password = ",".join(largest)
    return password


def find_total_interconnected_t_computers(text):
    connections = text.split("\n")
    network_graph = generate_network_map(connections)
    triangular_sets = find_triangular_sets(network_graph)
    return len(triangular_sets)

ans1 = find_total_interconnected_t_computers(text)
print("answer 1: ", ans1)

ans2 = find_password(text)
print("answer 2: ", ans2)
